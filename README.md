# Template create-react-app with express
Template slightly modified from [this article](https://dev.to/glitch/create-react-app-and-express-together-on-glitch-28gi)
